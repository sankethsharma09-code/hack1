        ...
        <div className="w-full md:w-5/12 lg:w-1/2">
          <div className="sticky top-24 animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="flex items-center justify-between mb-4 md:hidden">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Analysis Details</h2>
              <button 
                onClick={() => setSelectedItem(null)}
                className="p-2 text-gray-500 hover:text-gray-900 hover:bg-gray-100 dark:text-slate-400 dark:hover:text-white dark:hover:bg-white/10 rounded-full transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            
            <div className="bg-gray-50 dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-white/10 p-5 rounded-2xl mb-6 shadow-sm dark:shadow-inner">
              <p className="text-xs font-bold text-gray-500 dark:text-slate-500 mb-2 uppercase tracking-widest">Original Message</p>
              <p className="text-gray-900 dark:text-slate-200 italic">"{selectedItem.message}"</p>
            </div>
